...
<body>
    ...
    <table>
        <tr >
            ...
            <td style="border: 1px solid black;text-align:center;">Danh mục </td>
        ...
        while ($row = mysqli_fetch_array($ketqua)) {
            ...
            <img style='width:50px;height:50px;' src='$row[anh]'>
            <a style='text-decoration: none;margin-left:20px; color:red;' href ='admin.php?danhmuc=$row[id]'>$row[tendanhmuc]</a>
            </td>
            </tr>";
        }
        ?>
                                    ...
                                    <img class='card-img-top' src=" . $row['img'] . " />
                                            <div class='card-body p-4'>
                                                <div class='text-center'>
                                                   ...
                                                   Giá <h6 class='fw-bolder'>$row[gia] $</h6>
                                                   Số lượng <p class='fw-bolder'>$row[soluong]</p>
                                            ...
                                            <div class='card-body p-4'>
                                                ...
                                                <div class='fa fa-trash'></div>_____________________
